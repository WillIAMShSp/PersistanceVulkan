...
namespace PersistanceBackend
{
	...
	void updateDescriptorSetPerFrame(std::vector<VkDescriptorSet>& descriptorSet, PersistanceUtils::ArrayView<VkWriteDescriptorSet> writeDescriptorSets = {nullptr, 0});
